...
it('can render with data-*', function () {
    Livewire::test(MyTime::class, ['data' => ['name' => 'main-time']])
        ->assertSee('data-name="main-time"', false);
});
...
it('can render with id', function () {
    Livewire::test(MyTime::class, ['id' => 'main-time'])
        ->assertSee('id="main-time"', false);
});
...
it('can render with slot', function () {
    Livewire::test(MyTime::class, ['slotAttribute' => 'main-time'])
        ->assertSee('slot="main-time"', false);
});
...
it('can render with title', function () {
    Livewire::test(MyTime::class, ['title' => 'main-time'])
        ->assertSee('title="main-time"', false);
});

it('can render with translate', function () {
    Livewire::test(MyTime::class, ['translate' => true])
        ->assertSee('translate');
});
