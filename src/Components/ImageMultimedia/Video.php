...
class Video extends Component
{
    ...
    /**
     * Prevents the browser from suggesting a Picture-in-Picture context menu or to request Picture-in-Picture
     * automatically in some cases.
     */
    public bool $disablepictureinpicture = false;
     ...
     *
     * @see https://drafts.csswg.org/css-values/#px
     * @see https://html.spec.whatwg.org/multipage/embedded-content.html#dimension-attributes
     */
    public int $height = 0;
    ...
    /**
     * A Boolean attribute indicating that the video is to be played "inline", that is, within the element's playback
     * area. Note that the absence of this attribute does not imply that the video will always be played in fullscreen.
     */
    public bool $playsinline = false;
    ...
    /**
     * The specific attributes for the video component
     */
    ...
    public function mount(): void
    {
        ...
        if ($this->disablepictureinpicture) {
            $this->specificAttributes->add(['disablepictureinpicture']);
        }
        ...
        if ($this->playsinline) {
            $this->specificAttributes->add(['playsinline']);
        }
        if ($this->poster) {
            $this->specificAttributes->add(['poster' => $this->poster]);
        }
        if ($this->preload) {
    ...
    {
        return view(
            'lw-bits::image_multimedia.video',
            [
